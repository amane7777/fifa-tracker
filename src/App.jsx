...
// ── Add bet form ──────────────────────────────────────────────────────────
function AddBet({ matches, markets, onAdd, onNavigate }) {
      ...
      {matchMode === "select" ? (
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Field label="Home team" style={{ flex: 1 }}>
            <input value={customHome} onChange={e => setCustomHome(e.target.value)} placeholder="Home" style={inputStyle()} />
          </Field>
          <Field label="Away team" style={{ flex: 1 }}>
            <input value={customAway} onChange={e => setCustomAway(e.target.value)} placeholder="Away" style={inputStyle()} />
          </Field>
        </div>
      )}
